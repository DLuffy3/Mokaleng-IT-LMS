...
from learning_management_app.forms import EditResultForm
from learning_management_app.models import Students, Subjects, StudentResult
...
class EditResultViewClass(View):
    def get(self, request, *args, **kwargs):
        ...
        return render(request, "staff_components/edit_student_result.html", {"form": edit_result_form})
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            return render(request, "staff_components/edit_student_result.html", {"form": form})
